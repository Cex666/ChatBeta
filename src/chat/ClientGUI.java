...
public class ClientGUI implements WindowListener{
	...
	public static void errore(String msgErr) {
		JOptionPane.showMessageDialog(null, msgErr, "ERRORE", 2);
	}
	...
	private void initialize() {
		...
		jFClient.addWindowListener(this);
		...
		btnConnetti.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				} else if (tFNomeUtente.getText().contains("@") || tFNomeUtente.getText().contains("/") || tFNomeUtente.getText().contains("\\")) {
